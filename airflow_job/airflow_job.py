...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds-dev-test")
    bq_project = Variable.get("bq_project", default_var="nimble-analyst-469212-h3")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "635926052050-compute@developer.gserviceaccount.com",
